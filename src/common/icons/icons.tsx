import { getCurrentBgColor } from "../../functions";
...
export const UpButtonIcon = (props: IconProps) => {
  const { mode } = darkModeStore();
  const { onClick } = props;
  return (
    <div className="up-custom-icons-style" onClick={onClick}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 320 512"
        fill={getCurrentBgColor(mode)}
